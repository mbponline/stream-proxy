...
namespace KvpbaseStreamTest
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            _Kvpbase = new KvpbaseStream(_ApiKey, _Endpoint, _UserGuid, _Container, _ObjectKey);
            ...
            while (_RunForever)
            {
                ...
                switch (userInput)
                {
                    ...
                    case "len":
                        Console.WriteLine(_Kvpbase.Length);
                        break;

                    case "pos":
                        Console.WriteLine(_Kvpbase.Position);
                        break;
                    ...
                    case "md":
                        Console.WriteLine(SerializeJson(_Kvpbase.Metadata, true));
                        break;
        ...
        static void Seek()
        {
            ...
            {
                case "begin":
                    _Kvpbase.Seek(offset, System.IO.SeekOrigin.Begin);
                    break;
                case "current":
                    _Kvpbase.Seek(offset, System.IO.SeekOrigin.Current);
                    break;
                case "end":
                    _Kvpbase.Seek(offset, System.IO.SeekOrigin.End);
                    break;
            }
        }
        ...
        static void Write()
        {
            ...
            _Kvpbase.Write(data, 0, data.Length);
        }
